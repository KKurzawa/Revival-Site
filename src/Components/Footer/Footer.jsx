...
function Footer() {
    return (
        <footer className=' bg-[#fe4701] h-48 flex flex-col justify-end border-t-8 border-white'>
            ...
            <a href='https://immense-everglades-74554-f9bad473782a.herokuapp.com/' target="_blank" rel="noreferrer">
                <p className='flex justify-end text-white hover:text-[#ffffffb7] transition-all duration-300 mt-5 mr-2 text-xl'>Site Designed and Built by Kris Kurzawa</p>
            </a>
        </footer>
