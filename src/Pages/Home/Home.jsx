    ...
    return (
        <div className='bg-[#130253]'>
            ...
            <main className='flex lg:hidden flex-col justify-center text-8xl text-white'>
                <LazyLoadImage src={Testimonials} alt='RevivalPic2' className='border-b-8 border-[#c94c2c]' />
                <h2 className='homeText flex justify-center mt-40 pt-1 pb-1'>The Ultimate</h2>
                ...
                <h3 className='homeText flex justify-center mt-40 pt-1 pb-1'>Featuring</h3>
                <h3 className='detroit flex justify-center pt-1 pb-1 text-[#c94c2c]'>Detroit's</h3>
                <h3 className='homeText flex justify-center pt-1 pb-1'>A-List </h3>
                <h3 className='homeText flex justify-center mb-40 pt-1 pb-1'>Musicians</h3>
            </main>
            <main className='hidden lg:flex flex-col justify-center text-6xl text-white'>
                <LazyLoadImage src={Testimonials} alt='RevivalPic2' className='border-b-8 border-[#c94c2c]' />
                <h2 className='homeText flex justify-center pt-7 pb-1'>The Ultimate Allman Brothers Experience</h2>
                <h3 className='homeText flex justify-center pb-7'>Featuring<span className='detroit text-[#c94c2c]'>&nbsp;Detroit's&nbsp;</span> A-List Musicians</h3>
            </main>
        </div>
    )
}
