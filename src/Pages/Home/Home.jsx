...
function Home() {
    return (
        <main className='bg-[#130253]'>
            {/* <div className='bg-gradient-to-b from-[#130253] via-[#130253] to-[#c94c2c] lg:to-[#130253]'> */}
            <article className='flex lg:hidden flex-col justify-center text-8xl text-[#c94c2c]'>
            ...
            <article className='hidden lg:flex flex-col justify-center text-6xl text-[#c94c2c]'>
                <LazyLoadImage src={Testimonials} alt='RevivalPic2' className='bodyContainer border-b-[17px] border-[#c94c2c]' />
