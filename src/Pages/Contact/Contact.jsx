    ...
    return (
        <main className='flex flex-col items-center pb-10 min-h-64 bg-[#130253]'>
            ...
            <form onSubmit={handleSubmit} className='emailForm flex flex-col content-center m-[20px] w-[50%]'>
                ...
                <button className='submit-button text-5xl outline-none border-[1px] border-[#f5f5f5] hover:text-[#de4c28] hover:bg-[#f5f5f5] ease-in-out duration-700 hover:text-[3.5rem] hover:w-[10.5rem] hover:h-[5.5rem] hover:border-4 hover:border-[#de4c28]' type='submit'>Submit</button>
            </form>
            {errorMessage && (
                <div>
