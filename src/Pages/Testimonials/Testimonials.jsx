    ...
    return (
        <main className="flex flex-col items-center md:mb-0 min-h-screen bg-[#130253]">
            ...
            <form onSubmit={handleSubmit} className=" text-[#f5f5f5] flex flex-col content-center mt-[20px] w-[50%]">
                ...
                <button className="post-button text-4xl border-[1px] border-[rgba(245,245,245,0.79)] hover:text-[#de4c28] hover:bg-[#f5f5f5] transition-all duration-700 hover:text-[2.3rem] hover:border-4 hover:border-[#de4c28]">Add Post</button>
            </form>
